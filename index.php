<!DOCTYPE html>
<?php
	include_once 'public/php/update.php';
?>
<html lang="pl">
<head>
    <meta charset="UTF-8">
...
<div id ="container">
    ...
    <div id = "menuicon" >
        <img alt="icon" src="public/img/menuicon.png">
    </div>
    </div>
    <div id = "smallwindowmenu">
        <div class="smallmenu">Informacje</div>
        <div class ="smallmenu">Zasady postępowania</div>
        <div class="smallmenu">Statystyki</div>
    </div>
    <div id="animation">
    ...
    <div id="maincontent">
        <div id="statsdiv">
            ...
            <div class="countystats">
				Podlaskie
				<div class="regiondeath"><?php echo $zgony[4]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[4]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[4]?></div>
			</div>
            <div class="countystats">
				Lubuskie
				<div class="regiondeath"><?php echo $zgony[5]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[5]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[5]?></div>
			</div>
            <div class="countystats">
				Wielkopolskie
				<div class="regiondeath"><?php echo $zgony[6]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[6]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[6]?></div>
			</div>
            <div class="countystats">
				Kujawsko-pomorskie
				<div class="regiondeath"><?php echo $zgony[7]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[7]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[7]?></div>
			</div>
            <div class="countystats">
				Mazowieckie
				<div class="regiondeath"><?php echo $zgony[8]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[8]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[8]?></div>
			</div>
            <div class="countystats">
				Lubelskie
				<div class="regiondeath"><?php echo $zgony[9]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[9]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[9]?></div>
			</div>
            <div class="countystats">
				Dolnośląskie
				<div class="regiondeath"><?php echo $zgony[10]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[10]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[10]?></div>
			</div>
            <div class="countystats">
				Opolskie
				<div class="regiondeath"><?php echo $zgony[11]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[11]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[11]?></div>
			</div>
            <div class="countystats">
				Śląskie
				<div class="regiondeath"><?php echo $zgony[12]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[12]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[12]?></div>
			</div>
            <div class="countystats">
				Małopolskie
				<div class="regiondeath"><?php echo $zgony[13]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[13]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[13]?></div>
			</div>
            <div class="countystats">
				Łódzkie
				<div class="regiondeath"><?php echo $zgony[14]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[14]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[14]?></div>
			</div>
            <div class="countystats">
				Świętokrzyskie
				<div class="regiondeath"><?php echo $zgony[15]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[15]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[15]?></div>
			</div>
            <div class="countystats">
				Podkarpackie
				<div class="regiondeath"><?php echo $zgony[16]?></div>
				<div class="regionrecoverd"><?php echo $wyzdrowienia[16]?></div>
				<div class="regionconfirmed"><?php echo $potwierdzone[16]?></div>
			</div>
        </div>
        <div id="map">
            <?xml version="1.0"?>
            <svg  version="1.2" viewbox="0 0 1000 948" width="75%" id="mappl"  xmlns="http://www.w3.org/2000/svg">
			<a name="Warmińsko-mazurskie" id = "Warmińsko-mazurskie" onmouseenter="showMapInfo('Warmińsko-mazurskie','<?php echo $potwierdzone[3]?>','<?php echo $wyzdrowienia[3]?>','<?php echo $zgony[3]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Pomorskie" name="Pomorskie" id = "Pomorskie" onmouseenter="showMapInfo('Pomorskie','<?php echo $potwierdzone[2]?>','<?php echo $wyzdrowienia[2]?>','<?php echo $zgony[2]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Dolnośląskie" name="Dolnośląskie" id = "Dolnośląskie" onmouseenter="showMapInfo('Dolnośląskie','<?php echo $potwierdzone[10]?>','<?php echo $wyzdrowienia[10]?>','<?php echo $zgony[10]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Zachodniopomorskie" name="Zachodniopomorskie" id = "Zachodniopomorskie" onmouseenter="showMapInfo('Zachodniopomorskie','<?php echo $potwierdzone[1]?>','<?php echo $wyzdrowienia[1]?>','<?php echo $zgony[1]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Lubuskie"  name="Lubuskie" id = "Lubuskie"onmouseenter="showMapInfo('Lubuskie','<?php echo $potwierdzone[5]?>','<?php echo $wyzdrowienia[5]?>','<?php echo $zgony[5]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Wielksopolskie" name="Wielksopolskie" id = "Wielksopolskie" onmouseenter="showMapInfo('Wielkopolskie','<?php echo $potwierdzone[6]?>','<?php echo $wyzdrowienia[6]?>','<?php echo $zgony[6]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Kujawsko-pomorskie" name="Kujawsko-pomorskie" id = "Kujawsko-pomorskie" onmouseenter="showMapInfo('Kujawsko-pomorskie','<?php echo $potwierdzone[7]?>','<?php echo $wyzdrowienia[7]?>','<?php echo $zgony[7]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Śląskie" name="Śląskie" id = "Śląskie" onmouseenter="showMapInfo('Śląskie','<?php echo $potwierdzone[12]?>','<?php echo $wyzdrowienia[12]?>','<?php echo $zgony[12]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Łódzkie" name="Łódzkie" id = "Łódzkie" onmouseenter="showMapInfo('Łódzkie','<?php echo $potwierdzone[14]?>','<?php echo $wyzdrowienia[14]?>','<?php echo $zgony[14]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Mazowieckie" name="Mazowieckie" id = "Mazowieckie" onmouseenter="showMapInfo('Mazowieckie','<?php echo $potwierdzone[8]?>','<?php echo $wyzdrowienia[8]?>','<?php echo $zgony[8]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Świętokrzyskie"  name="Świętokrzyskie" id = "Świętokrzyskie" onmouseenter="showMapInfo('Świętokrzyskie','<?php echo $potwierdzone[15]?>','<?php echo $wyzdrowienia[15]?>','<?php echo $zgony[15]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Podlaskie" name="Podlaskie" id = "Podlaskie" onmouseenter="showMapInfo('Podlaskie','<?php echo $potwierdzone[4]?>','<?php echo $wyzdrowienia[4]?>','<?php echo $zgony[4]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Lubelskie" name="Lubelskie" id = "Lubelskie" onmouseenter="showMapInfo('Lubelskie','<?php echo $potwierdzone[9]?>','<?php echo $wyzdrowienia[9]?>','<?php echo $zgony[9]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Podkarpackie" name="Podkarpackie" id = "Podkarpackie" onmouseenter="showMapInfo('Podkarpackie','<?php echo $potwierdzone[16]?>','<?php echo $wyzdrowienia[16]?>','<?php echo $zgony[16]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Opolskie" name="Opolskie" id = "Opolskie" onmouseenter="showMapInfo('Opolskie','<?php echo $potwierdzone[11]?>','<?php echo $wyzdrowienia[11]?>','<?php echo $zgony[11]?>')" onmouseleave="hideMapInfo()">
			...
			<a xlink:title="Małopolskie" name="Małopolskie" id = "Małopolskie" onmouseenter="showMapInfo('Małopolskie','<?php echo $potwierdzone[13]?>','<?php echo $wyzdrowienia[13]?>','<?php echo $zgony[13]?>')" onmouseleave="hideMapInfo()">
